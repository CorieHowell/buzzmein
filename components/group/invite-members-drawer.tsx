  ...
  return (
    <>
      ...
      <button
        ...
        className="flex w-full items-center gap-4 rounded-2xl bg-gray-100 px-4 py-3 text-left transition-opacity active:opacity-70"
      >
      ...
      {open && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
            <div className="w-full max-w-sm rounded-3xl bg-background p-6">
              {/* Header */}
